...
I vores tidligere projekter har vi erfaret Gantt's begrænsninger som primær styringsværktøj i korte iterative projekter. Da Gantt forudsætter et klart overblik over forløbet, strider dette imod UP's agile og iterative natur, hvor krav og design ændres mellem iterationerne. Som Larman påpeger, arbejdes der i iterative processer, ikke med en fuldt detaljeret plan for hele projektet fra start: _“There isn't a detailed plan for the entire project. There is a high-level plan”_ @larmanApplyingUMLPatterns.
