/*
Skrivemål:
- Forklare formålet med at bruge use case model
- Forklare vores tilgang til artefaktet:
*/

/*
= Arbejde med use cases.md
---
created: 2026-03-13
section: Inception
exclude: false
...
Vi arbejder med use cases på følgende måde:
1. Vi laver en liste af use cases ud fra vores domæne model og ordanalyse (PO udsagn).
2. Udvider dem alle til brief.
3. Vi rangerer dem ud fra risiko og værdiskabelse.
4. Udvælger de vigtigste 10-20%, som laves til fully dressed.
5. De fully dressed use cases oversættes til tekniske implamenterings opgaver.
6. Herefter pointgives hver opgave i backloggen(ovenstående opgaver)
7. Vi laver en detaljeret plan over næste iteration og en general plan over alle iterationerne.

= Brug af AI til Use cases.md
---
created: 2026-03-12
section: Refleksion
exclude: false
sortKey: 0.5048
---
Vi valgte at få AI til at generere Use Cases ud fra vores domænemodel inden vi selv skrev Use Cases. Begrænsede det vores egen kreativitet da vi derefter selv skrev Use Cases?

= Domænemodel før Use Cases.md
---
created: 2026-03-12
section: Refleksion
exclude: false
sortKey: 0.54363
---
Vi arbejdede ud fra et kort udsagn fra PO (se 'svar fra klient'). Med den begrænsede domæneviden og uden et løbende samspil med klienten vurderede vi, at det gav mening at klarlægge domænet yderligere ved at udarbejde en domænemodel før Use Cases.

Det går mod Larmans proces, hvor domænemodel laves på baggrund af udarbejdede Use Cases. Her er det dog udgangspunktet, at det er i samspil med forretningsdomænet.

= Tanker over Use Cases.md
---
sortKey: 0.53838
section: Inception
created: 2026-03-12
exclude: false
---
Ud fra AI-genererede pain points diskuterer vi, hvilke briefs vi skal skrive ud. Vi snakker om, hvordan vi kan reliefe noget pain ved at skabe bedre overblik over bookingsystemet end der i forvejen er i outlook.

Vores system kan måske ikke skabe gains, men snarere reliefe pains (Medarbejdere har allerede et bookingsystem i Outlook, men behøver en simplere oversigt)
